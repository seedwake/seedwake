...
RECENT_ACTION_ECHO_RETAIN_CYCLES = 5
RECENT_ACTION_ECHO_RETAIN_SECONDS = 3600
    ...
    def _sync_to_redis(self) -> None:
        ...
        for stimulus in shadow_items:
            ...
            if stimulus.type == "conversation":
                _sync_conversation_history(redis_client, stimulus, history_ids, self._event_callback)
...
def _sync_conversation_history(
    ...
    if _has_complete_merged_history_payload(merged_messages, merged_ids):
        ...
        return
    _sync_single_conversation_history(redis_client, stimulus, existing_history_ids, event_callback)
